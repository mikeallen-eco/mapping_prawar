...
my_data <- read.csv("prawar_data/2024_class_data/prawar_class_data_2023b.csv") %>%
...
QUESTION 6: Do you think there is a relationship between song duration and number of syllables? Explain.
```{r}
